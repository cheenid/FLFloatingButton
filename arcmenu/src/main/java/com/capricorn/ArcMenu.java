...
public class ArcMenu extends RelativeLayout {
    ...
    public void setAlignMent(boolean alignRight) {
        ...
        if (!alignMent) {
            ...
            mArcLayout.setArc(200+90, 340+90);
        }
        invalidate();
        requestLayout();
    }
    ...
    //    private ArcMenuListener arcMenuListener;
    public void setArcMenuListener(ArcMenuListener arcMenuListener) {
//        this.arcMenuListener = arcMenuListener;
        mArcLayout.setArcMenuListener(arcMenuListener);
    }
