...
public class FloatingViewManager implements ScreenChangedListener, View.OnTouchListener, TrashViewListener {
    ...
    public void setButtonMode(boolean buttonMode) {
        ...
        for (FloatingView fw : mFloatingViewList) {
            fw.setButtonMode(buttonMode);
            fw.setOnTouchListener(buttonMode ? null : this);
            fw.setDraggable(!buttonMode);
        }
...
//            mTrashView.dismiss();
    ...
    public void addViewToWindow(View view, Options options,FloatingViewListener callback) {
        ...
        floatingView.setCallback(callback);
